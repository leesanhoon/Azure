...
class Program
{
    ...
    {
        var connectionString = "Server=tcp:netcoreazureninh.database.windows.net,1433;Initial Catalog=netcoreazure;Encrypt=True;TrustServerCertificate=False;Connection Timeout=60;Authentication=Active Directory Default;";
